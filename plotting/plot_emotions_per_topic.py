...
def plot_topic_polarity(polarity, dates, topics, timeline, lexicon):
    ...
    for i in range(len(timeline['date'])): 
        ...
        plt.text(timeline['date'][i], ymin, timeline['event'][i], rotation=90, verticalalignment='left', fontsize=15, color = '0.6')
        plt.text(timeline['date'][i], ymax, letters[i], rotation = 90, verticalalignment='right', fontsize=15, color='0.75')
