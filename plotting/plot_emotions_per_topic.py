...
def plot_emotions_topic(emotions, timeline, topic):
    ...
    plt.plot(emotions[emotions['fear_emotag'] + emotions['fear_nrc'] !=0]['dates'], emotions[emotions['fear_emotag'] + emotions['fear_nrc'] !=0]['fear_emotag'] + emotions[emotions['fear_emotag'] + emotions['fear_nrc'] !=0]['fear_nrc'], color = 'tab:olive', label = 'Fear')
